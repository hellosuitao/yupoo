...
<div class="logo_products">
    <div class="container">
        ...
        <div class="w3ls_logo_products_left">
            <h1><a href="/indexFindAll">测试页面</a></h1>
        </div>
        <div class="w3l_search">
            <form action="#" method="post">
                <input type="search" name="Search" placeholder="搜索测试...	" required="">
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="/indexFindAll" class="act">首页</a>
                    </li>
                    <li class="dropdown">
                            ...
                            <div class="row">
                                <div class="multi-gd-img">
                                    <ul class="multi-column-dropdown">
                                        ...
                                        <#--												<li>-->
                                        <#--													<a href="category.html">B</a>-->
                                        <#--												</li>-->
                                        <#--												<li>-->
                                        <#--													<a href="category.html">C</a>-->
                                        <#--												</li>-->
                                        <#--												<li>-->
                                        <#--													<a href="category.html">D</a>-->
                                        <#--												</li>-->
                                        <#--												<li>-->
                                        <#--													<a href="category.html">E</a>-->
                                        <#--												</li>-->
    ...
    <div class="container">
        ...
        <div class="grid_3 grid_5">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">风景照片展示</a></li>
                <li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">人物照片展示</a></li>
            </ul>-->
                <div id="myTabContent" class="tab-content" style="background-color: #FE9126;">
                    <div role="tabpanel" class="tab-pane fade in active" id="expeditions"
                         aria-labelledby="expeditions-tab">
                        <div class="agile-tp">
                            <h5>广告位</h5>
                            <p class="w3l-ad">此处可以对下面图片进行描述或广告宣传。</p>
                        </div>
                        <div class="agile_top_brands_grids">
                                                ...
                                                <figure>
                                                    <div class="snipcart-item block">
                                                        <div class="snipcart-thumb">
                                                            <a href="findAlbumById?id=${a.id}"><img title=" " alt=" "
                                                                                                    src="${a.coverpath}"
                                                                                                    height="200px"
                                                                                                    width="200px"/></a>
                                                            <p>${a.name}</p>
                            ...
                            <#--														<div class="snipcart-item block">-->
                            <#--															<div class="snipcart-thumb">-->
                            <#--																<a href="product.ftl"><img title=" " alt=" " src="images/1.png" /></a>-->
                            <#--																<p>商品名称</p>-->
                            <#--																<div class="stars">-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                            ...
                            <#--																<div id="dianzan" style="font-size: 12px;padding-top: 20px;text-align: center;">-->
                            <#--																	<span class="like">&#10084;</span><span id="num">1000+</span>-->
                            <#--																	<span style="padding-left: 20px;">浏览量：</span><span id="liulan">23888</span>-->
                            <#--																</div>-->
                            <#--															</div>-->
                            <#--															-->
                            <#--														</div>-->
                            ...
                            <#--														<div class="snipcart-item block">-->
                            <#--															<div class="snipcart-thumb">-->
                            <#--																<a href="product.ftl"><img title=" " alt=" " src="images/2.png" /></a>-->
                            <#--																<p>商品名称</p>-->
                            <#--																<div class="stars">-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                            ...
                            <#--														<div class="snipcart-item block">-->
                            <#--															<div class="snipcart-thumb">-->
                            <#--																<a href="product.ftl"><img src="images/3.png" alt=" " class="img-responsive" /></a>-->
                            <#--																<p>商品名称</p>-->
                            <#--																<div class="stars">-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                            <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        ...
                        <#--														<div class="snipcart-item block">-->
                        <#--															<div class="snipcart-thumb">-->
                        <#--																<a href="product.ftl"><img title=" " alt=" " src="images/4.png" /></a>-->
                        <#--																<p>商品名称</p>-->
                        <#--																<div class="stars">-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        ...
                        <#--														<div class="snipcart-item block">-->
                        <#--															<div class="snipcart-thumb">-->
                        <#--																<a href="product.ftl"><img title=" " alt=" " src="images/5.png" /></a>-->
                        <#--																<p>商品名称</p>-->
                        <#--																<div class="stars">-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        ...
                        <#--														<div class="snipcart-item block">-->
                        <#--															<div class="snipcart-thumb">-->
                        <#--																<a href="product.ftl"><img src="images/6.png" alt=" " class="img-responsive" /></a>-->
                        <#--																<p>商品名称</p>-->
                        <#--																<div class="stars">-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                        <#--																	<i class="fa fa-star blue-star" aria-hidden="true"></i>-->
                    ...
                    <nav class="numbering">
                        <ul class="pagination paging">
                            ...
                            <li>
                                <a href="http://localhost:8080/indexFindAll?page=${albumPage.number}"
                                   aria-label="Previous">
							...
							<#if 5 <= albumPage.totalPages >
								<#if albumPage.number<2>
									<#list  1..5 as y>
										<li class="active">
											<a href="http://localhost:8080/indexFindAll?page=${y-1}">${y}<span class="sr-only">(current)</span></a>
										</li>
									</#list>
								<#elseif albumPage.totalPages <= albumPage.number+1>
									<#list  albumPage.number-3..albumPage.number+1 as c>
										<li class="active">
											<a href="http://localhost:8080/indexFindAll?page=${c-1}">${c}<span class="sr-only">(current)</span></a>										</li>
									</#list>
								<#elseif albumPage.totalPages <= albumPage.number+2>
									<#list  albumPage.number-2..albumPage.number+2 as c>
										<li class="active">
											<a href="http://localhost:8080/indexFindAll?page=${c-1}">${c}<span class="sr-only">(current)</span></a>
										</li>
									</#list>
								<#else>
									<#list  albumPage.number-1..albumPage.number+3 as z>
										<li class="active">
											<a href="http://localhost:8080/indexFindAll?page=${z-1}">${z}<span class="sr-only">(current)</span></a>
										</li>
									</#list>
								</#if>
							<#else>
...
<#--                            <li class="active">-->
<#--                                <a href="http://localhost:8080/indexFindAll?page=${i}">${i+1}<span class="sr-only">(current)</span></a>-->
<#--                            </li>-->
<#--                            </#list>-->
                            ...
                            <#--									</li>-->
                            <li>
                                <a href="http://localhost:8080/indexFindAll?page=${albumPage.number+1}"
                                   aria-label="Next">
...
<#--                <ul class="info">-->
<#--                    <li><i class="fa fa-arrow-right" aria-hidden="true"></i>-->
<#--                        <a href="groceries.html">A类</a>-->
<#--                    </li>-->
<#--                    <li><i class="fa fa-arrow-right" aria-hidden="true"></i>-->
<#--                        <a href="household.html">B类</a>-->
<#--                    </li>-->
<#--                    <li><i class="fa fa-arrow-right" aria-hidden="true"></i>-->
<#--                        <a href="personalcare.html">C类</a>-->
<#--                    </li>-->
<#--                    <li><i class="fa fa-arrow-right" aria-hidden="true"></i>-->
<#--                        <a href="category.html">D类</a>-->
<#--                    </li>-->
<#--                    <li><i class="fa fa-arrow-right" aria-hidden="true"></i>-->
<#--                        <a href="beverages.html">E类</a>-->
<#--                    </li>-->
<#--                </ul>-->
<#--            </div>-->
            <div class="col-md-3 w3_footer_grid">
